...
|---|---|---|---|---|
| agents | `idx_agents_status_v2` | `status, created_at` | No | Filter agents by lifecycle state and ordered by created_at |
| agents | `idx_agents_created_at` | `created_at` | No | Order agents chronologically |

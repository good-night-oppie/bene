...
- **Problem**: Benchmark/claims docs (RIVAL-BENCH-REPORT.md, CLAIMS-AUDIT.md) likely present numbers without OCAR — table dump then conclusion, or conclusion then table dump, with no Challenge framing. Reader doesn't know what question the number answers.

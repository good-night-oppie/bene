...
1. **Outcome/plasticity-weighted retrieval ranking** (A1b, A2) — `record_outcome` counters never feed search ranking; decay/demotion is planned, not shipped.

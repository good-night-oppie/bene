# ai-lint-override: R-II-001 - Pre-existing lazy imports throughout (subprocess, time, bene.metaharness.*, bene.memory, bene.shared_log, bene.skills) are out of scope for this PR
# ai-lint-override: R-EH-001 - Pre-existing broad exception swallows in dispatch helpers are out of scope for this PR
"""MCP Server — exposes BENE as an MCP server for Claude Code integration.
...
- Memory: write, search, read
- Shared log: intent, vote, decide, append, read
- Skills: save, search, apply, list, outcome tracking
"""
...
def init_server(afs: Bene, ccr: ClaudeCodeRunner) -> Server:
    """Initialize the MCP server with BENE (Bene) and CCR instances."""
    global _afs, _ccr
    _afs = afs
    _ccr = ccr
    return server
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "status_filter": {
                        "type": "string",
                        "description": "Filter by status (running, completed, failed, paused, killed)",
                    },
                },
            },
        ),
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "candidates_per_iteration": {
                        "type": "integer",
                        "description": "Candidates proposed per iteration",
                        "default": 2,
                    },
                    "config": {
                        "type": "object",
                        "description": "Additional SearchConfig overrides",
                        "default": {},
                    },
                },
                "required": ["benchmark"],
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "search_agent_id": {
                        "type": "string",
                        "description": "Search agent ID from mh_search",
                    },
                },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "search_agent_id": {
                        "type": "string",
                        "description": "Search agent ID to resume",
                    },
                    "benchmark": {
                        "type": "string",
                        "description": "Benchmark name (must match original search)",
                    },
                },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "eval_subset": {
                        "type": "integer",
                        "description": "Subsample problems for faster eval",
                    },
                    "compaction_level": {
                        "type": "integer",
                        "description": "Digest compaction 0-10",
                        "default": 5,
                    },
                },
                "required": ["benchmark"],
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "search_agent_id": {
                        "type": "string",
                        "description": "Search agent ID from mh_start_search",
                    },
                    "source_code": {
                        "type": "string",
                        "description": "Complete Python source code with def run(problem)",
                    },
                    "rationale": {
                        "type": "string",
                        "description": "Why this harness should improve on prior candidates",
                    },
                },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "code_template": {
                        "type": "string",
                        "description": "Code template or example (optional)",
                    },
                },
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "n_agents": {
                        "type": "integer",
                        "default": 2,
                        "description": "Number of co-evolving agents (2-4)",
                    },
                    "eval_subset": {
                        "type": "integer",
                        "description": "Subsample problems per eval",
                    },
                    "compaction_level": {"type": "integer", "default": 5},
                    "hub_sync_interval": {
                        "type": "integer",
                        "default": 2,
                        "description": "Auto-sync every N iterations",
                    },
                },
                "required": ["benchmark"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "content": {
                        "type": "string",
                        "description": "Free-text content to store (FTS5 indexed)",
                    },
                    "type": {
                        "type": "string",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "agent_id": {
                        "type": "string",
                        "description": "Restrict to one agent (optional)",
                    },
                },
                "required": ["query"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "memory_id": {
                        "type": "integer",
                        "description": "Specific memory_id to fetch (omit to list)",
                    },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "action": {
                        "type": "string",
                        "description": "Description of what the agent plans to do",
                    },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "ref_id": {
                        "type": "integer",
                        "description": "Reference to a prior log_id (optional)",
                    },
                },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "tail": {
                        "type": "integer",
                        "description": "Return last N entries (overrides since_position)",
                    },
                },
            },
        ),
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "template": {
                        "type": "string",
                        "description": "Prompt template with {param} placeholders",
                    },
                    "source_agent_id": {
                        "type": "string",
                        "description": "Agent that discovered this skill",
                    },
                    "tags": {
                        "type": "array",
                        "items": {"type": "string"},
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "tag": {
                        "type": "string",
                        "description": "Filter by exact tag (applied after FTS ranking)",
                    },
                },
                "required": ["query"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "skill_id": {
                        "type": "integer",
                        "description": "Skill ID from skill_search or skill_list",
                    },
                    "params": {
                        "type": "object",
                        "description": "Parameter values for the template placeholders",
                    },
                    "outcome": {
                        "type": "string",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "success": {
                        "type": "boolean",
                        "description": "True = succeeded, False = failed",
                    },
                },
...
def _do_hub_sync(search_agent_id: str, hub_id: str, afs: Bene) -> dict:
    ...
    try:
        ...
        for point in frontier_data.get("points", [])[:3]:
            ...
            try:
                ...
                afs.write(
                    hub_id, f"/best_per_agent/agent_{agent_index}/{hid}.scores.json", scores_b
                )
    ...
    try:
        for se in afs.ls(search_agent_id, "/skills"):
            ...
            try:
                afs.write(
                    hub_id, f"/shared_skills/{se['name']}", afs.read(search_agent_id, se["path"])
                )
            except Exception:
                pass
    except Exception:
...
def _agent_has_harness(afs: Bene, agent_id: str, harness_id: str) -> bool:
...
async def _dispatch(name: str, args: dict[str, Any]) -> str:
    ...
    if name == "agent_spawn":
        ...
        return json.dumps(_afs.list_agents(status_filter=args.get("status_filter")), indent=2)
    ...
    # ── Agent VFS ────────────────────────────────────────────
        ...
        _afs.write(args["agent_id"], args["path"], data)
        return f"Written {len(data)} bytes to {args['agent_id']}:{args['path']}"
    ...
    # ── Orchestration ────────────────────────────────────────
        ...
        if not isinstance(tasks, list) or not tasks:
            raise ValueError(
                f"agent_parallel requires a non-empty `tasks` list; got {type(tasks).__name__}"
            )
        for i, t in enumerate(tasks):
            if not isinstance(t, dict):
                raise TypeError(f"agent_parallel tasks[{i}] must be a dict, got {type(t).__name__}")
            for required in ("name", "prompt"):
                if not t.get(required):
                    raise ValueError(
                        f"agent_parallel tasks[{i}] missing required field {required!r}"
                    )

        config_file = args.get("config_file", "") or os.environ.get("BENE_CONFIG", "./bene.yaml")

        # Pre-spawn agents synchronously so callers can poll status
        # via agent_status as soon as the response is returned.
        spec: list[dict] = []
        for t in tasks:
            agent_id = _afs.spawn(
                name=t["name"],
            ...
            spec.append({"agent_id": agent_id, "prompt": t["prompt"]})

        log_dir = os.path.dirname(os.path.abspath(_afs.db_path))
        stamp = int(_time.time())
        spec_path = os.path.join(log_dir, f"bene-parallel-{stamp}.json")
        try:
            ...
            for s in spec:
                try:
                    _afs.fail(s["agent_id"], error=f"spec-write failed: {e}")
                except Exception:  # noqa: BLE001
                    logger.exception("Failed to mark orphan agent %s as failed", s["agent_id"])
            raise

        cmd = [
            sys.executable,
            "-m",
            "bene.ccr.parallel_worker",
            "--db",
            _afs.db_path,
            "--config-file",
            config_file,
        ...
        log_path = os.path.join(log_dir, f"bene-parallel-{stamp}.log")
        log_file = open(log_path, "w")  # intentionally leaked to the detached child
        proc = _sp.Popen(cmd, stdout=log_file, stderr=log_file, **kwargs)
        logger.info(
            "agent_parallel worker launched: PID %d, agents=%s, log=%s",
            proc.pid,
            [s["agent_id"] for s in spec],
            log_path,
        )
        ...
        return json.dumps(
            {
                "status": "running",
                "agent_ids": [s["agent_id"] for s in spec],
                "pid": proc.pid,
                "log_path": log_path,
                "spec_path": spec_path,
                "message": (
                    f"Parallel worker launched (PID {proc.pid}, {len(spec)} agents). "
                    "Poll with agent_status."
                ),
            },
            indent=2,
        )
    ...
    # ── Meta-Harness ────────────────────────────────────────
        ...
        cmd = [
            ...
            benchmark_name,
            "--iterations",
            str(args.get("max_iterations", 10)),
            "--candidates",
            str(args.get("candidates_per_iteration", 2)),
            "--max-parallel",
            str(args.get("config", {}).get("max_parallel_evals", 4)),
        ]
        ...
        mh_kw: dict[str, Any] = {"env": env}
        if sys.platform == "win32":
            mh_kw["creationflags"] = _sp.CREATE_NEW_PROCESS_GROUP | _sp.DETACHED_PROCESS
        else:
            mh_kw["start_new_session"] = True

        import time as _time

        log_dir = os.path.dirname(os.path.abspath(_afs.db_path))
        log_path = os.path.join(log_dir, f"bene-worker-{int(_time.time())}.log")
        log_file = open(log_path, "w")
        proc = _sp.Popen(cmd, stdout=log_file, stderr=log_file, **mh_kw)
        ...
        try:
            frontier = json.loads(_afs.read(search_agent_id, "/pareto/frontier.json").decode())
            frontier_resp["frontier"] = frontier
        except FileNotFoundError:
            frontier_resp["frontier"] = None
            frontier_resp["message"] = "Frontier not yet computed — seeds may still be evaluating."

        # Count harnesses evaluated so far
        harness_dirs = _afs.ls(search_agent_id, "/harnesses")
        frontier_resp["harnesses_evaluated"] = len(harness_dirs)

        return json.dumps(frontier_resp, indent=2)
        ...
        search_agent_id = args["search_agent_id"]
        benchmark_name = args["benchmark"]
        config_file = os.environ.get("BENE_CONFIG", "./bene.yaml")
        ...
        env = {k: v for k, v in os.environ.items() if k != "CLAUDECODE"}
        mhr_kw: dict[str, Any] = {"env": env}
        if sys.platform == "win32":
            mhr_kw["creationflags"] = _sp.CREATE_NEW_PROCESS_GROUP | _sp.DETACHED_PROCESS
        else:
            mhr_kw["start_new_session"] = True
        ...
        log_path = os.path.join(log_dir, f"bene-worker-{int(_time.time())}.log")
        log_file = open(log_path, "w")
        proc = _sp.Popen(cmd, stdout=log_file, stderr=log_file, **mhr_kw)
    ...
    # ── Collaborative Meta-Harness ────────────────────────────
        ...
        from bene.metaharness.harness import SearchConfig, HarnessCandidate
        ...
        for harness, eval_r in zip(seeds, seed_results):
            search._store_result(harness, eval_r, iteration=0)
            ...
            harness_data.append(
                {
                    ...
                    "iteration": 0,
                    "scores": eval_r.scores,
                    "source": harness.source_code,
                    "per_problem": eval_r.per_problem,
                    "error": eval_r.error,
                }
            )
        ...
        from bene.metaharness.harness import HarnessCandidate, SearchConfig
        ...
        if not pending_dicts:
            return json.dumps(
                {"error": "No pending candidates. Submit harnesses with mh_submit_candidate first."}
            )
        ...
        eval_results = await evaluator.evaluate_parallel(
            candidates,
            problems=problems,
            max_parallel=config.max_parallel_evals,
        )
        ...
        for harness, eval_r in zip(candidates, eval_results):
            ...
            _afs.write(search_agent_id, f"{base}/scores.json", eval_r.to_scores_json().encode())
            if eval_r.per_problem:
                _afs.write(
                    search_agent_id,
                    f"{base}/per_problem.jsonl",
                    "\n".join(json.dumps(p) for p in eval_r.per_problem).encode(),
                )
            _afs.write(
                search_agent_id,
                ...
                json.dumps(
                    {
                        ...
                        "is_success": eval_r.is_success,
                        "error": eval_r.error,
                        "duration_ms": eval_r.duration_ms,
                    },
                    indent=2,
                ).encode(),
            )
            # Store verifier diagnosis
            if hasattr(eval_r, "diagnosis") and eval_r.diagnosis:
                _afs.write(
                    search_agent_id,
                    f"{base}/diagnosis.json",
                    json.dumps(eval_r.diagnosis.to_dict(), indent=2).encode(),
                )
        ...
        from bene.metaharness.prompts import (
            build_pivot_prompt,
        ...
        frontier_improved = any(
            ...
            len(frontier.points) > (_afs.get_state_or(search_agent_id, "prev_frontier_size") or 0)
        )
        ...
        should_pivot = stagnant >= stagnation_threshold and (
            pivot_fired_at is None or stagnant - pivot_fired_at >= stagnation_threshold
        )
        if should_pivot:
        ...
        for path in all_scores_files:
            ...
            try:
                meta = json.loads(
                    _afs.read(search_agent_id, f"/harnesses/{hid}/metadata.json").decode()
                )
            ...
            try:
                ...
                h["per_problem"] = [
                    json.loads(line) for line in pp.strip().split("\n") if line.strip()
                ]
            except FileNotFoundError:
                h["per_problem"] = []
        ...
        for harness, eval_r in zip(candidates, eval_results):
            ...
            if hasattr(eval_r, "diagnosis") and eval_r.diagnosis:
                diagnoses.append(eval_r.diagnosis.to_text())
            ...
            try:
                ...
                if not prev_best:
                    ...
                    eval_r.scores.get(o, 0.0) - prev_best.get(o, 0.0) > ep for o in eval_r.scores
                ):
                    attempt_status = "improved"
                elif any(
                    prev_best.get(o, 0.0) - eval_r.scores.get(o, 0.0) > ep for o in eval_r.scores
                ):
                ...
                _afs.write(
                    search_agent_id,
                    f"/attempts/{harness.harness_id}.json",
                    json.dumps(
                        {
                            "harness_id": harness.harness_id,
                            "iteration": iteration,
        ...
        if should_pivot:
            ...
            if frontier.points:
                try:
                    raw = _afs.read(
                        search_agent_id, f"/harnesses/{frontier.points[0].harness_id}/source.py"
                    ).decode()
        ...
        full_digest = (
            skills_prefix + digest + diagnosis_text + reflect_text + pivot_text + consolidation_text
        )
        ...
        try:
            knowledge_id = _afs.get_or_create_singleton(
                "bene-knowledge",
        ...
        return json.dumps(
            {
                "status": "ok",
                "skill": skill_name,
                "message": f"Skill '{skill_name}' saved and persisted to knowledge agent.",
            },
            indent=2,
        )
        ...
        for i in range(n_agents):
            ...
            seed_results_i = await search_i.evaluator.evaluate_parallel(
                seeds_i,
                problems=problems_i,
                max_parallel=config_i.max_parallel_evals,
            )
            for hc_i, er_i in zip(seeds_i, seed_results_i):
                search_i._store_result(hc_i, er_i, iteration=0)
        ...
        if not hub_id:
            return json.dumps(
                {"error": "Agent not in a co-evolution run. Use mh_spawn_coevolution first."}
            )
        hub_resp = _do_hub_sync(search_agent_id, hub_id, _afs)
        return json.dumps(hub_resp, indent=2)
    ...
    # -- Cross-Agent Memory --
        ...
        mem_entries = mem.list(
            agent_id=args.get("agent_id"),
            type=args.get("type"),
            limit=args.get("limit", 20),
        )
        return json.dumps([e.to_dict() for e in mem_entries], indent=2)
    ...
    # -- Shared Log (LogAct) --
        ...
        return json.dumps(log_entry.to_dict(), indent=2)

    elif name == "shared_log_decide":
        from bene.shared_log import SharedLog

        log = SharedLog(_afs.conn)
        log_entry = log.decide(intent_id=args["intent_id"], agent_id=args["agent_id"])
        return json.dumps(log_entry.to_dict(), indent=2)
        ...
        if args.get("tail") is not None:
            log_entries = log.tail(args["tail"])
        else:
            log_entries = log.read(
                since_position=args.get("since_position", 0),
                limit=args.get("limit", 50),
                type=args.get("type"),
                agent_id=args.get("agent_id"),
            )
        return json.dumps([e.to_dict() for e in log_entries], indent=2)
    ...
    # -- Cross-Agent Skill Library (Zhou et al. 2026, arXiv:2604.08224) --
        ...
        sk = SkillStore(_afs.conn)
        skill_hits = sk.search(
            query=args["query"],
            limit=args.get("limit", 10),
            tag=args.get("tag"),
        )
        return json.dumps([s.to_dict() for s in skill_hits], indent=2)
        ...
        return json.dumps(
            {
                ...
                "success_rate": round(skill.success_count / skill.use_count, 3)
                if skill and skill.use_count
                else None,
            },
            indent=2,
        )

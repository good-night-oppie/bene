...
# Migration to v7: fast single-column index for querying latest agents
# ⚡ Bolt Optimization: Eliminates SQLite Temp B-Tree when rendering Dashboards with latest agents
MIGRATION_V7_SQL = """
CREATE INDEX IF NOT EXISTS idx_agents_created_at_desc_v2 ON agents(created_at DESC);
"""

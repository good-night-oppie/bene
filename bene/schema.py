...
# Migration to v7: fast compound index for fetching recent agents and filtering by status
# Eliminates SQLite Temp B-Tree on `ORDER BY created_at` when listing/searching agents.
MIGRATION_V7_SQL = """
